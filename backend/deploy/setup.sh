...
echo ""
echo "3. After deploy, set up daily DB backups to Nevacloud S3:"
echo "   ${BLUE}cp deploy/env.backup-s3.example .backup-s3.env && nano .backup-s3.env${NC}"
echo "   ${BLUE}sudo ./deploy/install-backup-cron.sh${NC}"
echo "   See ${BLUE}deploy/DATABASE_BACKUP.md${NC} for the full guide."
echo ""

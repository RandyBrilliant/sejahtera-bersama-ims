        ...
        <>
          <section className="border-outline-variant space-y-4 rounded-xl border p-6">
            ...
            <textarea
              ...
              rows={3}
              className={cn(
                'border-input bg-background placeholder:text-muted-foreground min-h-[5.25rem] w-full rounded-lg border px-3 py-2 text-sm outline-none transition-[color,box-shadow]',
